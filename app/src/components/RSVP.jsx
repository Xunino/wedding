...
const ScrollingRow = ({ items, reverse = false }) => (
    <div className={`flex whitespace-nowrap overflow-hidden py-2 md:py-6 relative z-10 
    ...
    >
        <div className={`flex gap-8 md:gap-32 ${reverse ? 'animate-marquee-reverse' : 'animate-marquee'} items-center`}>
            {[...items, ...items, ...items].map((item, i) => (
                <div key={i} className="flex items-center gap-4 md:gap-8">
                    <span
                        className={`text-3xl md:text-7xl font-script tracking-wide
                    ...
                    <Heart className={`w-4 h-4 md:w-6 md:h-6 ${reverse ? 'text-rose-300/30' : 'text-rose-400/30'} fill-current`} />
                </div>
            ))}
        </div>
    </div>
    ...
    return (
        <section id="rsvp" className="py-10 md:py-20 bg-stone-50 relative overflow-hidden flex items-center">
            ...
            <div className="absolute inset-0 flex flex-col justify-center pointer-events-none select-none overflow-hidden">
                <div className="flex flex-col gap-6 md:gap-10 -rotate-[8deg] scale-110 opacity-80 origin-center transform translate-y-8">
